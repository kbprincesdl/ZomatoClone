                        ...
                        <div class="tabs">
                            ...
                            <div class="tab">
                                ...
                                <div class="content">
                                    ...
                                    <li  key={i}>
                                        <span className="input-label">{ this.Items[item].name }</span>
                                    </li>
                                    ))}</div>
                            ...
                            <div class="tab">
                                ...
                                <div className="head">Phone Number</div>
                                    ...
                                    <div className="head">{restaurant.qty}</div>
                                    <div className="value">{`${restaurant.price}, ${restaurant.qty}`}</div>
                                </div>
                            </div>
                        </div>
...
export default Details2;  // exporting the component